...
# build-storage.sh - Storage Infrastructure Deployment
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "Next steps:"
    echo "1. Ensure network infrastructure is deployed (./build-network.sh)"
    echo "2. Run ./build-mongodbvm.sh to deploy compute and application resources"
    echo "=========================================="
else
